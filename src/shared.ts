...
export const BROWSER_AUTO_OPEN_DISABLED_LINE = 'ZenMux browser auto-open is disabled.'
/** Prefix for the trusted OAuth origin emitted alongside an authorization URL. */
export const OAUTH_ORIGIN_LINE_PREFIX = 'ZenMux OAuth origin: '
/** Same-origin, read-only browser endpoint used to refresh OAuth command cards. */
export const ZENMUX_BROWSER_STATUS_PATH = '/zenmux/oauth/status'
